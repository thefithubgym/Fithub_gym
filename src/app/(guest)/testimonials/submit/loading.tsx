export default function TestimonialSubmitLoading() {
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] min-h-screen font-sans antialiased overflow-x-hidden py-12 px-container-margin flex flex-col justify-center items-center animate-pulse">
