  ...
  return (
    <div className="flex flex-col gap-lg w-full animate-pulse">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-md">
        <div>
          <div className="h-10 bg-[#181818] border border-[#323232] rounded-xl w-44 mb-sm"></div>
          <div className="h-5 bg-[#181818] border border-[#323232] rounded-lg w-full max-w-lg"></div>
        </div>
        <div className="bg-[#181818] border border-[#323232] rounded-xl px-lg py-md w-36 h-[50px] shrink-0"></div>
      </div>
      ...
      <div className="bg-[#181818] border border-[#323232] rounded-xl flex flex-col shadow-sm mt-md w-full max-w-full">
        ...
        <div className="p-md border-b border-[#323232] flex flex-col md:flex-row gap-md items-center justify-between w-full">
          <div className="flex flex-col sm:flex-row items-center gap-md w-full md:w-auto">
            ...
            <div className="flex gap-sm w-full sm:w-auto justify-between sm:justify-start">
              <div className="h-12 bg-[#262626] rounded-xl w-32"></div>
              <div className="h-12 bg-[#262626] rounded-xl w-36"></div>
            </div>
          </div>
          {/* Active status summary count skeleton */}
          <div className="h-6 bg-[#262626] rounded-md w-44 self-start md:self-auto"></div>
        </div>
        ...
        <div className="overflow-x-auto w-full max-w-full">
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#131313]/50 border-b border-[#323232]">
              <tr>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Member Name</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Contacts</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Plan Type</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Expires In</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Status</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#323232]/50 font-body-md text-sm bg-[#181818]">
              {[1, 2, 3, 4, 5].map((i) => (
                <tr key={i} className="border-b border-[#323232]/30">
                  <td className="py-md px-lg">
                    <div className="flex items-center gap-md">
                      <div className="w-10 h-10 rounded-full bg-[#262626] shrink-0"></div>
                      <div className="flex flex-col gap-xs">
                        <div className="h-4 bg-[#262626] rounded-md w-32"></div>
                        <div className="h-3 bg-[#262626] rounded-md w-16"></div>
                      </div>
                    </div>
                  </td>
                  <td className="py-md px-lg">
                    <div className="flex flex-col gap-xs">
                      ...
                      <div className="h-3 bg-[#262626] rounded-md w-36"></div>
                    </div>
                  </td>
                  <td className="py-md px-lg">
                    <div className="flex flex-col gap-xs">
