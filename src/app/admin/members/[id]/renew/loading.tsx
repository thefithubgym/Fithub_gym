...
export default function RenewMemberLoading() {
  return (
    <div className="flex flex-col gap-lg w-full animate-pulse pb-xl">
      ...
      <div className="bg-[#181818] border border-[#323232] rounded-xl p-xl flex flex-col gap-md max-w-2xl w-full mx-auto">
        <div className="h-7 bg-[#262626] rounded-md w-64 mb-xs"></div>
        <div className="h-4 bg-[#262626] rounded-md w-40 mb-lg"></div>
