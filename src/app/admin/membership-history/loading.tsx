export default function MembershipHistoryLoading() {
  return (
    <div className="flex flex-col gap-lg w-full animate-pulse">
      {/* Page Header */}
      <div>
        <div className="h-10 bg-[#181818] border border-[#323232] rounded-xl w-72 mb-sm"></div>
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#131313]/50 border-b border-[#323232]">
              <tr>
                ...
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Plan Details</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Duration</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Amount Paid</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Status</th>
                <th className="py-md px-lg font-label-sm text-xs text-[#B3B3B3] uppercase tracking-widest font-semibold">Receipt</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#323232]/50 font-body-md text-sm bg-[#181818]">
              {[1, 2, 3, 4, 5].map((i) => (
                <tr key={i} className="border-b border-[#323232]/30">
                  ...
                  <td className="py-md px-lg">
                    <div className="w-20 h-8 bg-[#262626] rounded-lg"></div>
                  </td>
                </tr>
              ))}
            </tbody>
